...
class RFM69_ATC: public RFM69 {
  public:
    ...
    bool sendWithRetry(uint8_t toAddress, const void* buffer, uint8_t bufferSize, uint8_t retries=2, uint8_t retryWaitTime=140); // 40ms roundtrip req for 61byte packets
